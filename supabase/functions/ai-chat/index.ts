...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are an intelligent AI farming assistant for the Farmer Friend application. 
Your role is to provide accurate, contextual, and helpful advice to farmers about:
